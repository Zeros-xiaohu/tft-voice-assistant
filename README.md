...
你说，它查，你只需做决策。唯一不需要截图、不需要打字、不需要安装任何东西的云顶 AI 产品。

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2FZeros-xiaohu%2Ftft-voice-assistant)
...
| 功能     | 用户输入               | 输出                                    |
| -------- | ---------------------- | --------------------------------------- |
| 英雄配装 | "布里茨装备"           | Top 5 推荐装备 + avg/Top4/胜率/选取次数 |
...
> 战中决策 Agent。正在打游戏时使用，AI 自主感知局面、调用工具查实时数据、配合你做决策。
...
用户: 反曲弓和大剑
Agent: 📊 物理开局。[查数据] 🎯 推荐: 德莱文赌狗 or 诺手赌狗
       📦 反曲弓+大剑→巨人杀手，优先合成

用户: 2-1了，海克斯有战士之心、法师之心
Agent: 选战士之心。和你装备方向一致。法师之心忽略。
```
